...
if yes_no == "y":
    ...
    transformer_data_empty = pd.DataFrame(columns=['scn_name','trafo_id','bus0','bus1','x','r','g','b','s_nom','s_nom_extendable','s_nom_min','s_nom_max','tap_ratio','pashe_shift','capital_cost','geom','topo'])
    ...
    transformer_data_new = transformer_data_new[['scn_name','trafo_id','bus0','bus1','x','r','g','b','s_nom','s_nom_extendable','s_nom_min','s_nom_max','tap_ratio','pashe_shift','capital_cost','geom','topo']]
