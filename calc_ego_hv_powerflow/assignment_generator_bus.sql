...
UPDATE orig_geo_powerplants.proc_power_plant_germany a
	...
	WHERE ST_Intersects (a.geom, ST_TRANSFORM(b.geom,4326)) =TRUE AND voltage_level >= 3; 
...
(
  ...
  CONSTRAINT generator_data_bus_fk FOREIGN KEY (bus)
...
INSERT INTO orig_geo_powerplants.pf_generator_single (generator_id)
	...
	WHERE conv_id NOT IN 
		...
		); -- pumped storage units are ignored here and will be listed in storage table 
...
WHERE a.generator_id = b.un_id and b.capacity >= 50;
