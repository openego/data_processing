...
Data: Status quo renewable power plants in Germany
...
-- Table: supply.ego_renewable_power_plants_germany
...
-- Index: supply.ego_renewable_power_plants_germany_idx
-- DROP INDEX supply.ego_renewable_power_plants_germany_idx;

CREATE INDEX ego_renewable_power_plants_germany_idx
  ON supply.ego_renewable_power_plants_germany
  USING gist
  (geom);
