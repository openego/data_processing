...
SELECT scenario_log('eGo_DP', 'v0.4.5','input','model_draft','ego_demand_loadarea','ego_dp_loadarea_peakload.sql',' ');
SELECT scenario_log('eGo_DP', 'v0.4.5','input','scenario','ego_slp_parameters','ego_dp_loadarea_peakload.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.5','output','model_draft','ego_demand_loadarea','ego_dp_loadarea_peakload.sql',' ');
