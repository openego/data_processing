...
SELECT ego_scenario_log('v0.2.5','input','model_draft','ego_demand_load_melt','process_eGo_loads_per_grid_district.sql',' ');

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','input','model_draft','ego_grid_mv_griddistrict','process_eGo_loads_per_grid_district.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','temp','model_draft','ego_demand_loadarea_smaller100m2_mview','process_eGo_loads_per_grid_district.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','output','model_draft','ego_demand_loadarea','process_eGo_loads_per_grid_district.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','input','social','destatis_zensus_population_per_ha_mview','process_eGo_loads_per_grid_district.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','input','economic','ioer_urban_share_industrial_centroid','process_eGo_loads_per_grid_district.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','input','openstreetmap','osm_deu_polygon_urban_sector_1_residential_mview','process_eGo_loads_per_grid_district.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','output','model_draft','ego_osm_sector_per_griddistrict_1_residential','process_eGo_loads_per_grid_district.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','input','openstreetmap','osm_deu_polygon_urban_sector_2_retail_mview','process_eGo_loads_per_grid_district.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','output','model_draft','ego_osm_sector_per_griddistrict_3_industrial','process_eGo_loads_per_grid_district.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','input','openstreetmap','osm_deu_polygon_urban_sector_4_agricultural_mview','process_eGo_loads_per_grid_district.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','output','model_draft','ego_osm_sector_per_griddistrict_4_agricultural','process_eGo_loads_per_grid_district.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','input','model_draft','ego_political_boundary_bkg_vg250_6_gem_clean','process_eGo_loads_per_grid_district.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','temp','model_draft','ego_demand_loadarea_error_noags_mview','process_eGo_loads_per_grid_district.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','temp','model_draft','ego_demand_loadarea_ta','process_eGo_loads_per_grid_district.sql',' ');
*/ 
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','temp','model_draft','ego_demand_loadarea_spf','process_eGo_loads_per_grid_district.sql',' ');
*/ 
