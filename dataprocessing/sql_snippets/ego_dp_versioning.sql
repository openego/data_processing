...
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_dp_ehv_substation','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_dp_hvmv_substation','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_dp_mvlv_substation','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_dp_ehv_griddistrict','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_dp_mv_griddistrict','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_dp_lv_griddistrict','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','demand','ego_dp_loadarea','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','supply','ego_dp_conv_powerplant','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','supply','ego_dp_res_powerplant','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_bus','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_generator','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_generator_pq_set','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_line','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_load','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_load_pq_set','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_source','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_storage','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_storage_pq_set','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_temp_resolution','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_transformer','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_extension_bus','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_extension_generator','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_extension_generator_pq_set','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_extension_line','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_extension_link','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_extension_load','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_extension_load_pq_set','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_extension_source','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_extension_storage','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_extension_storage_pq_set','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_extension_temp_resolution','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_extension_transformer','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_line_expansion_costs','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','supply','ego_renewable_feedin','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','supply','ego_power_class','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','supply','ego_aggr_weather','ego_dp_versioning.sql','versioning');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP','v0.4.4','result','grid','ego_pf_hv_data_check','ego_dp_versioning.sql','versioning');
