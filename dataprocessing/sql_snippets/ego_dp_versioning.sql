...
SELECT ego_scenario_log('v0.3.0','input','model_draft','ego_grid_ehv_substation','ego_dp_versioning.sql','versioning');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.3.0','input','model_draft','ego_grid_hvmv_substation','ego_dp_versioning.sql','versioning');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.3.0','input','model_draft','ego_grid_mvlv_substation','ego_dp_versioning.sql','versioning');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.3.0','input','model_draft','ego_grid_ehv_substation_voronoi','ego_dp_versioning.sql','versioning');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.3.0','input','model_draft','ego_grid_mv_griddistrict','ego_dp_versioning.sql','versioning');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.3.0','input','model_draft','ego_grid_lv_griddistrict','ego_dp_versioning.sql','versioning');
