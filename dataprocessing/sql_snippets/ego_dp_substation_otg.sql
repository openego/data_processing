...
SELECT ego_scenario_log('v0.2.6','input','grid','otg_ehvhv_bus_data','otg_id_to_substations.sql',' ');

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','input','model_draft','ego_grid_hvmv_substation','otg_id_to_substations.sql',' ');

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','input','model_draft','ego_grid_ehv_substation','otg_id_to_substations.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','output','model_draft','ego_grid_hvmv_substation','otg_id_to_substations.sql',' ');
...
UPDATE model_draft.ego_grid_ehv_substation
	...
	-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','output','model_draft','ego_grid_ehv_substation','otg_id_to_substations.sql',' ');
