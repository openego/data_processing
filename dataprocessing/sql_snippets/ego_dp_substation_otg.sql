...
SELECT scenario_log('eGo_DP', 'v0.4.4','input','grid','otg_ehvhv_bus_data','ego_dp_substation_otg.sql',' ');
SELECT scenario_log('eGo_DP', 'v0.4.4','input','model_draft','ego_grid_hvmv_substation','ego_dp_substation_otg.sql',' ');
SELECT scenario_log('eGo_DP', 'v0.4.4','input','model_draft','ego_grid_ehv_substation','ego_dp_substation_otg.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','output','model_draft','ego_grid_hvmv_substation','ego_dp_substation_otg.sql',' ');
...
DELETE FROM model_draft.ego_grid_ehv_substation WHERE otg_id IS NULL;
	...
	-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','output','model_draft','ego_grid_ehv_substation','ego_dp_substation_otg.sql',' ');
