...
SELECT scenario_log('eGo_DP', 'v0.4.1','output','model_draft','ego_supply_generator','ego_dp_powerflow_assignment_unid.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.1','output','model_draft','ego_dp_supply_res_powerplant','ego_dp_powerflow_assignment_unid.sql',' ');
SELECT scenario_log('eGo_DP', 'v0.4.1','output','model_draft','ego_dp_supply_conv_powerplant','ego_dp_powerflow_assignment_unid.sql',' ');
