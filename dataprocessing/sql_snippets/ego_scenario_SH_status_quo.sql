...
----------------
-- Create a new scenario 'SH_Status_Quo' for the electricity grid in Schleswig-Holstein 
----------------

-- Filter buses whose geometries intersect with the polygon of Schleswig-Holstein 

DELETE FROM model_draft.ego_grid_pf_hv_bus WHERE scn_name = 'SH_Status_Quo'; 

INSERT INTO model_draft.ego_grid_pf_hv_bus
SELECT 'SH_Status_Quo', a.bus_id, a.v_nom, a.current_type, a.v_mag_pu_min, a.v_mag_pu_max, a.geom
...
DELETE FROM model_draft.ego_grid_pf_hv_line WHERE scn_name = 'SH_Status_Quo'; 

INSERT INTO 	model_draft.ego_grid_pf_hv_line
SELECT 'SH_Status_Quo', a.line_id, a.bus0, a.bus1, a.x, a.r, a.g, a.b, a.s_nom, a.s_nom_extendable, a.s_nom_min, 
...
WHERE 	scn_name= 'Status Quo' AND a.bus0 IN (SELECT bus_id FROM model_draft.ego_grid_pf_hv_bus WHERE scn_name = 'SH_Status_Quo') 
	AND a.bus1 IN (SELECT bus_id FROM model_draft.ego_grid_pf_hv_bus WHERE scn_name = 'SH_Status_Quo'); 


-- Filter data from .bus_v_mag_set for new scenario

DELETE FROM model_draft.ego_grid_pf_hv_bus_v_mag_set WHERE scn_name = 'SH_Status_Quo'; 
 
INSERT INTO model_draft.ego_grid_pf_hv_bus_v_mag_set
SELECT 'SH_Status_Quo', a.bus_id, a.temp_id, a.v_mag_pu_set
FROM model_draft.ego_grid_pf_hv_bus_v_mag_set a
WHERE scn_name= 'Status Quo' AND a.bus_id IN (SELECT bus_id FROM model_draft.ego_grid_pf_hv_bus WHERE scn_name = 'SH_Status_Quo');



-- Filter data from .generator for new scenario

DELETE FROM model_draft.ego_grid_pf_hv_generator WHERE scn_name = 'SH_Status_Quo'; 

INSERT INTO model_draft.ego_grid_pf_hv_generator
SELECT 'SH_Status_Quo', a.generator_id, a.bus, a.dispatch, a.control, a.p_nom, a.p_nom_extendable, a.p_nom_min, a.p_nom_max, 
...
WHERE scn_name= 'Status Quo' AND a.bus IN (SELECT bus_id FROM model_draft.ego_grid_pf_hv_bus WHERE scn_name = 'SH_Status_Quo'); 



-- Filter data from .generator_pq_set for new scenario

DELETE FROM model_draft.ego_grid_pf_hv_generator_pq_set WHERE scn_name = 'SH_Status_Quo'; 

INSERT INTO model_draft.ego_grid_pf_hv_generator_pq_set
SELECT 'SH_Status_Quo', a.generator_id, a.temp_id, a.p_set, a.q_set, a.p_min_pu, a.p_max_pu
FROM model_draft.ego_grid_pf_hv_generator_pq_set a
WHERE scn_name= 'Status Quo' AND a.generator_id IN (SELECT generator_id FROM model_draft.ego_grid_pf_hv_generator WHERE scn_name = 'SH_Status_Quo'); 

 

-- Filter data from .load for new scenario

DELETE FROM model_draft.ego_grid_pf_hv_load WHERE scn_name = 'SH_Status_Quo'; 

INSERT INTO model_draft.ego_grid_pf_hv_load
SELECT 'SH_Status_Quo', a.load_id, a.bus, a.sign, a.e_annual
...
DELETE FROM model_draft.ego_grid_pf_hv_load_pq_set WHERE scn_name = 'SH_Status_Quo'; 

INSERT INTO model_draft.ego_grid_pf_hv_load_pq_set
SELECT 'SH_Status_Quo', a.load_id, a.temp_id, a.p_set, a.q_set
FROM model_draft.ego_grid_pf_hv_load_pq_set a
WHERE scn_name= 'Status Quo' AND a.load_id IN (SELECT load_id FROM model_draft.ego_grid_pf_hv_load WHERE scn_name = 'SH_Status_Quo'); 


-- Filter data from .storage for new scenario

DELETE FROM model_draft.ego_grid_pf_hv_storage WHERE scn_name = 'SH_Status_Quo'; 

INSERT INTO model_draft.ego_grid_pf_hv_storage
SELECT 'SH_Status_Quo', a.storage_id, a.bus, a.dispatch, a.control, a.p_nom, a.p_nom_extendable, a.p_nom_min, a.p_nom_max, 
...
WHERE scn_name = 'SH_Status_Quo';

-- Filter data from .storage_pq_set for new scenario

DELETE FROM model_draft.ego_grid_pf_hv_storage_pq_set WHERE scn_name = 'SH_Status_Quo'; 

INSERT INTO model_draft.ego_grid_pf_hv_storage_pq_set
SELECT 'SH_Status_Quo', a.storage_id, a.temp_id, a.p_set, a.q_set, a.p_min_pu, a.p_max_pu, a.soc_set, a.inflow 
FROM model_draft.ego_grid_pf_hv_storage_pq_set a
WHERE scn_name= 'Status Quo' AND a.storage_id IN (SELECT storage_id FROM model_draft.ego_grid_pf_hv_storage WHERE scn_name = 'SH_Status_Quo'); 


-- Only include transformers connecting buses within the boundaries of the federal state

DELETE FROM model_draft.ego_grid_pf_hv_transformer WHERE scn_name = 'SH_Status_Quo'; 

INSERT INTO model_draft.ego_grid_pf_hv_transformer
SELECT 'SH_Status_Quo', a.trafo_id, a.bus0, a.bus1, a.x, a.r, a.g, a.b, a.s_nom, a.s_nom_extendable, a.s_nom_min, 
