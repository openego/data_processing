...
SELECT ego_scenario_log('v0.2.9','input','supply','ego_renewable_powerplant','ego_dp_preprocessing_res_powerplant.sql','');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.9','temp','model_draft','ego_supply_res_powerplant','ego_dp_preprocessing_res_powerplant.sql','');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.9','output','model_draft','ego_supply_res_powerplant','ego_dp_preprocessing_res_powerplant.sql','');
