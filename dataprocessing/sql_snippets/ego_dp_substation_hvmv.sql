...
SELECT scenario_log('eGo_DP', 'v0.4.2','input','openstreetmap','osm_deu_ways','ego_dp_substation_hvmv.sql',' ');
SELECT scenario_log('eGo_DP', 'v0.4.2','input','openstreetmap','osm_deu_polygon','ego_dp_substation_hvmv.sql',' ');
SELECT scenario_log('eGo_DP', 'v0.4.2','input','openstreetmap','osm_deu_nodes','ego_dp_substation_hvmv.sql',' ');
SELECT scenario_log('eGo_DP', 'v0.4.2','input','openstreetmap','osm_deu_line','ego_dp_substation_hvmv.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.2','temp','model_draft','way_substations','ego_dp_substation_hvmv.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.2','temp','model_draft','way_substations_with_110kV','ego_dp_substation_hvmv.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.2','temp','model_draft','way_substations_without_110kV','ego_dp_substation_hvmv.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.2','temp','model_draft','node_substations_with_110kV','ego_dp_substation_hvmv.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.2','temp','model_draft','way_lines_110kV','ego_dp_substation_hvmv.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.2','temp','model_draft','way_substations_without_110kV_intersected_by_110kV_line','ego_dp_substation_hvmv.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.2','temp','model_draft','substation_110kV','ego_dp_substation_hvmv.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.2','temp','model_draft','summary_total','ego_dp_substation_hvmv.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.2','temp','model_draft','summary','ego_dp_substation_hvmv.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.2','input','boundaries','bkg_vg250_1_sta_union_mview','ego_dp_substation_hvmv.sql',' ');
SELECT scenario_log('eGo_DP', 'v0.4.2','temp','model_draft','summary_de','ego_dp_substation_hvmv.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.2','temp','model_draft','buffer_75','ego_dp_substation_hvmv.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.2','temp','model_draft','buffer_75_a','ego_dp_substation_hvmv.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.2','temp','model_draft','substations_to_drop','ego_dp_substation_hvmv.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.2','temp','model_draft','final_result','ego_dp_substation_hvmv.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.2','output','model_draft','ego_grid_hvmv_substation','ego_dp_substation_hvmv.sql',' '); 
