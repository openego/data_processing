...
INSERT INTO	model_draft.ego_scenario (version,version_name,release,comment,timestamp) VALUES
	...
	('v0.2.10', 'premiere', 'TRUE', 'first complete relase', '2017-03-24' ),
	('v0.2.10', 'debugbranch', 'FALSE', 'run blocks to debug', '2017-04-06' ),
	('v0.2.10', 'eastereggs', 'TRUE', 'big and small eggs everywhere', '2017-04-13' ),
	('v0.2.10', 'homerun', 'TRUE', 'finish in one run', '2017-04-13' );
