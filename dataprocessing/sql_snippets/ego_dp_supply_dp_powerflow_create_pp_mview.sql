...
SELECT ego_scenario_log('v0.3.0','output','supply','ego_supply_conv_powerplant_sq_mview','ego_dp_supply_powerflow_create_pp_mview.sql',' ');
SELECT ego_scenario_log('v0.3.0','output','supply','ego_supply_conv_powerplant_nep2035_mview','ego_dp_supply_powerflow_create_pp_mview.sql',' ');
SELECT ego_scenario_log('v0.3.0','output','supply','ego_supply_conv_powerplant_ego100_mview','ego_dp_supply_powerflow_create_pp_mview.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.3.0','output','supply','ego_supply_res_powerplant_sq_mview','ego_dp_supply_powerflow_create_pp_mview.sql',' ');
SELECT ego_scenario_log('v0.3.0','output','supply','ego_supply_res_powerplant_nep2035_mview','ego_dp_supply_powerflow_create_pp_mview.sql',' ');
SELECT ego_scenario_log('v0.3.0','output','supply','ego_supply_res_powerplant_ego100_mview','ego_dp_supply_powerflow_create_pp_mview.sql',' ');
