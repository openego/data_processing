...
COMMENT ON TABLE model_draft.ego_supply_wpa_per_mvgd IS '{
	...
	"reference_date": "",
	"sources": [
		{"name": "eGo dataprocessing", "description": "v0.3.0", "url": "https://github.com/openego/data_processing", "license": "GNU Affero General Public License Version 3 (AGPL-3.0)", "copyright": " " },
	...
	"contributors": [
		...
		{"name": "Ludwig Hülk", "email": "ludwig.huelk@rl-institut.de",
		"date": "28.03.2017", "comment": "Update to v0.3.0"}],
	"resources": [{
		"schema": {
			"fields": [
