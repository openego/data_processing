...
SELECT ego_scenario_log('v0.2.9','input','model_draft','ego_supply_res_powerplant','ego_dp_rea_m2.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.9','temp','model_draft','ego_supply_rea_m2_a_mview','ego_dp_rea_m2.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.9','temp','model_draft','ego_supply_rea_m2_windfarm','ego_dp_rea_m2.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.9','temp','model_draft','ego_supply_rea_m2_farm_temp','ego_dp_rea_m2.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.9','temp','model_draft','ego_supply_rea_m2_wpa_temp','ego_dp_rea_m2.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.9','temp','model_draft','ego_supply_rea_m2_jnt_temp','ego_dp_rea_m2.sql',' ');

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.9','input','model_draft','ego_supply_wpa_per_mvgd','ego_dp_rea_m2.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.9','output','model_draft','ego_supply_rea_m2_mview','ego_dp_rea_m2.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.9','output','model_draft','ego_supply_rea_m2_rest_mview','ego_dp_rea_m2.sql',' ');
