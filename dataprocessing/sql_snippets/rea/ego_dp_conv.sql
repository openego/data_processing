...
SELECT ego_scenario_log('v0.2.10','input','model_draft','ego_dp_supply_conv_powerplant','ego_dp_conv.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.10','output','model_draft','ego_dp_supply_conv_powerplant','ego_dp_conv.sql',' ');
