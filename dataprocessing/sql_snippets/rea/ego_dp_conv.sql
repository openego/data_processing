...
SELECT scenario_log('eGo_DP', 'v0.4.2','input','model_draft','ego_dp_supply_conv_powerplant','ego_dp_conv.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.2','output','model_draft','ego_dp_supply_conv_powerplant','ego_dp_conv.sql',' ');
