...
SELECT scenario_log('eGo_DP', 'v0.4.1','input','model_draft','ego_dp_supply_res_powerplant','ego_dp_rea_m4.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.1','temp','model_draft','ego_supply_rea_m4_a_mview','ego_dp_rea_m4.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.1','temp','model_draft','ego_supply_rea_m4_dea_temp','ego_dp_rea_m4.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.1','temp','model_draft','ego_supply_rea_m4_grid_wpa_temp','ego_dp_rea_m4.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.1','temp','model_draft','ego_supply_rea_m4_jnt_temp','ego_dp_rea_m4.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.1','output','model_draft','ego_supply_rea_m4_mview','ego_dp_rea_m4.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.1','output','model_draft','ego_supply_rea_m4_rest_mview','ego_dp_rea_m4.sql',' ');
