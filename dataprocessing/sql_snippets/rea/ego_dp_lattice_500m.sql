...
SELECT scenario_log('eGo_DP', 'v0.4.4','input','boundaries','bkg_vg250_1_sta_union_mview','ego_dp_lattice_500m.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','output','model_draft','ego_lattice_500m','ego_dp_lattice_500m.sql',' ');
