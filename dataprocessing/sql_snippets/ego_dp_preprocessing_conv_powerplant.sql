...
SELECT ego_scenario_log('v0.2.7','input','supply','ego_conventional_powerplant','ego_dp_preprocessing_conv_powerplant.sql','');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.7','temp','model_draft','ego_supply_conv_powerplant','ego_dp_preprocessing_conv_powerplant.sql','');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.7','output','model_draft','ego_supply_conv_powerplant','ego_dp_preprocessing_conv_powerplant.sql','');
