...
SELECT ego_scenario_log('v0.2.6','output','model_draft','ego_grid_pf_hv_bus','osmtgmod_to_pypsa.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','output','model_draft','ego_grid_pf_hv_line','osmtgmod_to_pypsa.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','output','model_draft','ego_grid_pf_hv_transformer','osmtgmod_to_pypsa.sql',' ');
