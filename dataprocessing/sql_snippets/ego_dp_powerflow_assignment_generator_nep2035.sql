...
SELECT ego_scenario_log('v0.2.8','output','model_draft','ego_supply_generator_nep2035','ego_dp_powerflow_assignment_generator_nep2035.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','input','model_draft','ego_supply_conv_powerplant_2035','ego_dp_powerflow_assignment_generator_nep2035.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','input','model_draft','ego_supply_rea_2035','ego_dp_powerflow_assignment_generator_nep2035.sql',' ');
