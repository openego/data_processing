...
CREATE TABLE 		model_draft.ego_grid_pf_hv_line (
	...
	x double precision DEFAULT 0, -- Unit: Ohm...
	r double precision DEFAULT 0, -- Unit: Ohm...
	g double precision DEFAULT 0, -- Unit: Siemens...
	b double precision DEFAULT 0, -- Unit: Siemens...
