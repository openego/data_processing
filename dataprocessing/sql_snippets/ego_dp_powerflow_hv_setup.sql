...
CREATE TABLE 		model_draft.ego_grid_pf_hv_result_meta (
	...
	branch_capacity_factor double precision,
	pf_post_lopf boolean,
	network_clustering boolean,
	storage_extendable boolean,
	load_shedding boolean,
	generator_noise boolean,
	minimize_loading boolean,
	k_mean_clustering boolean,
	parallelisation boolean,
	line_grouping boolean,	
...
"Column": [		   {"Name": "result_id",
				   ...
				   {"Name": "method",
                    ...
                    "Unit": "" },
				   {"Name": "gridversion",
                    "Description": "None for model_draft or Version number (e.g. v0.2.10) for grid schema",
                    "Unit": "" },
				   {"Name": "start_step",
				   ...
				   {"Name": "solver",
                    ...
                    "Unit": "" },
				   {"Name": "branch_capacity_factor",
                    "Description": "Factor to globally extend or lower branch capacities",
                    "Unit": "" },
				   {"Name": "pf_post_lopf",
                    "Description": "True if pf_post_lopf is enabled",
                    "Unit": "" },
				   {"Name": "network_clustering",
                    "Description": "True if network clustering is enabled",
                    "Unit": "" },
				   {"Name": "storage_extendable",
                    "Description": "True if storages should be set extendable",
                    "Unit": "" },
				   {"Name": "load_shedding",
                    "Description": "True if load shedding is enabled",
                    "Unit": "" },
				   {"Name": "generator_noise",
                    "Description": "True if generator noise is enabled",
                    "Unit": "" },
				   {"Name": "minimize_loading",
                    "Description": "True if minimize_loading is enabled",
                    "Unit": "" },
				   {"Name": "k_mean_clustering",
                    "Description": "True if k_mean_clustering is enabled",
                    "Unit": "" },
				   {"Name": "parallelisation",
                    "Description": "True if parallelisation is enabled",
                    "Unit": "" },
				   {"Name": "line_grouping",
                    "Description": "True if line grouping is enabled",
                    "Unit": "" },
				   {"Name": "misc",
                    "Description": "Other settings that without a column",
                    "Unit": "" },
				   {"Name": "comments",
