...
SELECT ego_scenario_log('v0.2.6','input','openstreetmap','osm_deu_ways','get_substations_ehv.sql',' ');

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','input','openstreetmap','osm_deu_polygon','get_substations_ehv.sql',' ');

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','input','openstreetmap','osm_deu_line','get_substations_ehv.sql',' ');

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','input','openstreetmap','osm_deu_nodes','get_substations_ehv.sql',' ');

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','input','openstreetmap','osm_deu_rels','get_substations_ehv.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','input','political_boundary','bkg_vg250_1_sta_union_mview','get_substations_ehv.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','output','model_draft','ego_grid_ehv_substation','get_substations_ehv.sql',' ');
