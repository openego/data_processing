...
SELECT ego_scenario_log('v0.2.8','input','openstreetmap','osm_deu_ways','ego_dp_substation_ehv.sql',' ');

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','input','openstreetmap','osm_deu_polygon','ego_dp_substation_ehv.sql',' ');

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','input','openstreetmap','osm_deu_line','ego_dp_substation_ehv.sql',' ');

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','input','openstreetmap','osm_deu_nodes','ego_dp_substation_ehv.sql',' ');

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','input','openstreetmap','osm_deu_rels','ego_dp_substation_ehv.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','input','political_boundary','bkg_vg250_1_sta_union_mview','ego_dp_substation_ehv.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','output','model_draft','ego_grid_ehv_substation','ego_dp_substation_ehv.sql',' ');
