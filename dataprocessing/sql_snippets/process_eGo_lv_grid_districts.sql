...
COMMENT ON TABLE model_draft."ego_grid_lv_grid_district" IS
'{
"Name": "eGo data processing - ego_grid_lv_grid_district",
"Source": [{
                  "Name": "open_eGo",
...
-- Select description
SELECT obj_description('model_draft.ego_grid_lv_grid_district'::regclass)::json;
