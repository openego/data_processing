...
SELECT ego_scenario_log('v0.2.5','input','model_draft','ego_demand_load_melt','ego_demand_loads_per_mv_voronoi.sql',' ');

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','input','model_draft','ego_grid_hvmv_substation_voronoi','ego_demand_loads_per_mv_voronoi.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','temp','model_draft','ego_demand_loadarea_voi_smaller100m2_mview','ego_demand_loads_per_mv_voronoi.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','output','model_draft','ego_demand_loadarea_voi','ego_demand_loads_per_mv_voronoi.sql',' ');
...
/* 
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','input','social','destatis_zensus_population_per_ha_mview','ego_demand_loads_per_mv_voronoi.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','input','economic','ioer_urban_share_industrial_centroid','ego_demand_loads_per_mv_voronoi.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','input','openstreetmap','osm_deu_polygon_urban_sector_1_residential_mview','ego_demand_loads_per_mv_voronoi.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','output','model_draft','ego_osm_sector_per_griddistrict_1_residential','ego_demand_loads_per_mv_voronoi.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','input','openstreetmap','osm_deu_polygon_urban_sector_2_retail_mview','ego_demand_loads_per_mv_voronoi.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','output','model_draft','ego_osm_sector_per_griddistrict_2_retail','ego_demand_loads_per_mv_voronoi.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','input','openstreetmap','osm_deu_polygon_urban_sector_3_industrial_mview','ego_demand_loads_per_mv_voronoi.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','output','model_draft','ego_osm_sector_per_griddistrict_3_industrial','ego_demand_loads_per_mv_voronoi.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','input','openstreetmap','osm_deu_polygon_urban_sector_4_agricultural_mview','ego_demand_loads_per_mv_voronoi.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','output','model_draft','ego_osm_sector_per_griddistrict_4_agricultural','ego_demand_loads_per_mv_voronoi.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','input','model_draft','ego_political_boundary_bkg_vg250_6_gem_clean','ego_demand_loads_per_mv_voronoi.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','temp','model_draft','ego_demand_loadarea_voi_error_noags_mview','ego_demand_loads_per_mv_voronoi.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','temp','model_draft','ego_demand_loadarea_voi_ta','ego_demand_loads_per_mv_voronoi.sql',' ');
*/ 
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.5','temp','model_draft','ego_demand_loadarea_voi_spf','ego_demand_loads_per_mv_voronoi.sql',' ');
*/ 
