...
SELECT ego_scenario_log('v0.2.9','input','social','destatis_zensus_population_per_ha_mview','ego_dp_loadarea_census.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.9','input','model_draft','ego_demand_la_osm','ego_dp_loadarea_census.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.9','output','model_draft','ego_demand_la_zensus','ego_dp_loadarea_census.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.9','output','model_draft','ego_demand_la_zensus_cluster','ego_dp_loadarea_census.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.9','output','model_draft','ego_social_zensus_per_la_mview','ego_dp_loadarea_census.sql',' ');
