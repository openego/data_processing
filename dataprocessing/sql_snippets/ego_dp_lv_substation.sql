...
SELECT ego_scenario_log('v0.2.10','input','model_draft','ego_demand_loadarea','ego_dp_lv_substation.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.10','temp','model_draft','ego_lattice_360m_lv','ego_dp_lv_substation.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.10','temp','model_draft','ego_grid_mvlv_substation','ego_dp_lv_substation.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.10','temp','model_draft','ego_grid_lv_loadarea_rest','ego_dp_lv_substation.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.10','input','model_draft','ego_grid_mv_griddistrict','ego_dp_lv_substation.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.10','output','model_draft','ego_grid_mvlv_substation','ego_dp_lv_substation.sql',' ');
