...
UPDATE model_draft.ego_supply_dp_conv_powerplant a
	SET 	otg_id =b.otg_id 
	FROM 	model_draft.ego_grid_hvmv_substation b
	WHERE 	a.subst_id = b.subst_id AND voltage_level > 2;
...
UPDATE model_draft.ego_supply_dp_res_powerplant
...
SELECT ego_scenario_log('v0.3.0','output','model_draft','ego_supply_dp_res_powerplant','ego_dp_powerflow_assignment_otgid.sql',' ');
SELECT ego_scenario_log('v0.3.0','output','model_draft','ego_supply_dp_conv_powerplant','ego_dp_powerflow_assignment_otgid.sql',' ');
