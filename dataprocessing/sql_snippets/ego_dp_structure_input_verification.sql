...
SELECT scenario_log('eGo_DP', 'v0.4.4','check','boundaries','bkg_vg250_1_sta','ego_dp_structure_input_verification.sql','preprocessing verification');
SELECT scenario_log('eGo_DP', 'v0.4.4','check','boundaries','bkg_vg250_2_lan','ego_dp_structure_input_verification.sql','preprocessing verification');
SELECT scenario_log('eGo_DP', 'v0.4.4','check','boundaries','bkg_vg250_4_krs','ego_dp_structure_input_verification.sql','preprocessing verification');
SELECT scenario_log('eGo_DP', 'v0.4.4','check','boundaries','bkg_vg250_6_gem','ego_dp_structure_input_verification.sql','preprocessing verification');
SELECT scenario_log('eGo_DP', 'v0.4.4','check','openstreetmap','osm_deu_polygon','ego_dp_structure_input_verification.sql','preprocessing verification');
SELECT scenario_log('eGo_DP', 'v0.4.4','check','openstreetmap','osm_deu_ways','ego_dp_structure_input_verification.sql','preprocessing verification');
SELECT scenario_log('eGo_DP', 'v0.4.4','check','openstreetmap','osm_deu_nodes','ego_dp_structure_input_verification.sql','preprocessing verification');
SELECT scenario_log('eGo_DP', 'v0.4.4','check','openstreetmap','osm_deu_line','ego_dp_structure_input_verification.sql','preprocessing verification');
SELECT scenario_log('eGo_DP', 'v0.4.4','check','scenario','ego_slp_parameters','ego_dp_structure_input_verification.sql','preprocessing verification');
SELECT scenario_log('eGo_DP', 'v0.4.4','check','grid','otg_ehvhv_bus_data','ego_dp_structure_input_verification.sql','preprocessing verification');
SELECT scenario_log('eGo_DP', 'v0.4.4','check','society','destatis_zensus_population_per_ha','ego_dp_structure_input_verification.sql','preprocessing verification');
SELECT scenario_log('eGo_DP', 'v0.4.4','check','economy','destatis_gva_per_district','ego_dp_structure_input_verification.sql','preprocessing verification');
SELECT scenario_log('eGo_DP', 'v0.4.4','check','demand','ego_demand_federalstate','ego_dp_structure_input_verification.sql','preprocessing verification');
SELECT scenario_log('eGo_DP', 'v0.4.4','check','supply','vernetzen_wind_potential_area','ego_dp_structure_input_verification.sql','preprocessing verification');
SELECT scenario_log('eGo_DP', 'v0.4.4','check','model_draft','ego_supply_res_powerplant_sq_mview','ego_dp_structure_input_verification.sql','preprocessing verification');
SELECT scenario_log('eGo_DP', 'v0.4.4','check','model_draft','ego_supply_conv_powerplant_sq_mview','ego_dp_structure_input_verification.sql','preprocessing verification');
...
-- scenario log (project, version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','setup','model_draft','ego_scenario_input','ego_dp_structure_input_verification.sql','preprocessing verification');
*/
