...
SELECT ego_scenario_log('v0.2.9','input','model_draft','ego_demand_per_district','ego_dp_loadarea_consumption.sql',' ');

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.9','input','model_draft','ego_demand_loadarea','ego_dp_loadarea_consumption.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.9','input','demand','ego_demand_federalstate','ego_dp_loadarea_consumption.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.9','output','model_draft','ego_demand_loadarea','ego_dp_loadarea_consumption.sql',' ');
