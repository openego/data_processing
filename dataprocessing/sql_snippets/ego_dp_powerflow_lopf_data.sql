...
SELECT ego_scenario_log('v0.2.6','output','model_draft','ego_grid_pf_hv_generator','LOPF_data.sql',' ');
...
*/
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','output','model_draft','ego_grid_pf_hv_generator_pq_set','LOPF_data.sql',' ');
