...
SELECT ego_scenario_log('v0.2.8','input','political_boundary','bkg_vg250_1_sta','ego_dp_structure_boundaries_vg250.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','output','political_boundary','bkg_vg250_1_sta_mview','ego_dp_structure_boundaries_vg250.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','output','political_boundary','bkg_vg250_1_sta_error_geom_mview','ego_dp_structure_boundaries_vg250.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','output','political_boundary','bkg_vg250_1_sta_union_mview','ego_dp_structure_boundaries_vg250.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','output','political_boundary','bkg_vg250_1_sta_bbox_mview','ego_dp_structure_boundaries_vg250.sql',' ');

	
-- 2. Bundesland (lan) - federal state (fst)

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','input','political_boundary','bkg_vg250_2_lan','ego_dp_structure_boundaries_vg250.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','output','political_boundary','bkg_vg250_2_lan_mview','ego_dp_structure_boundaries_vg250.sql',' ');


-- 4. Landkreis (krs) - district (dist)

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','input','political_boundary','bkg_vg250_4_krs','ego_dp_structure_boundaries_vg250.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','output','political_boundary','bkg_vg250_4_krs_mview','ego_dp_structure_boundaries_vg250.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','input','social','destatis_zensus_population_per_ha_mview','ego_dp_structure_boundaries_vg250.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','input','political_boundary','bkg_vg250_6_gem','ego_dp_structure_boundaries_vg250.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','output','political_boundary','bkg_vg250_6_gem_mview','ego_dp_structure_boundaries_vg250.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','output','political_boundary','bkg_vg250_6_gem_error_geom_mview','ego_dp_structure_boundaries_vg250.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','output','political_boundary','bkg_vg250_6_gem_dump_mview','ego_dp_structure_boundaries_vg250.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','output','model_draft','ego_political_boundary_bkg_vg250_6_gem_hole_mview','ego_dp_structure_boundaries_vg250.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','output','model_draft','ego_political_boundary_bkg_vg250_6_gem_clean','ego_dp_structure_boundaries_vg250.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','output','political_boundary','bkg_vg250_statistics_view','ego_dp_structure_boundaries_vg250.sql',' ');
