...
SELECT ego_scenario_log('v0.2.8','input','model_draft','ego_supply_res_powerplant','ego_dp_preprocessing_res_powerplant_2035.sql','');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.8','output','model_draft','ego_supply_res_powerplant_2035','ego_dp_preprocessing_res_powerplant_2035.sql','');
