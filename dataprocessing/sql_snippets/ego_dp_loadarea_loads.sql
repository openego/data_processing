...
SELECT ego_scenario_log('v0.2.6','input','model_draft','ego_demand_hv_largescaleconsumer','process_eGo_osm_loads.sql',' ');

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','input','openstreetmap','osm_deu_polygon_urban','process_eGo_osm_loads.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','output','openstreetmap','osm_deu_polygon_urban','process_eGo_osm_loads.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','temp','model_draft','osm_deu_polygon_urban_buffer100_mview','process_eGo_osm_loads.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','ouput','model_draft','ego_demand_la_osm','process_eGo_osm_loads.sql',' ');
