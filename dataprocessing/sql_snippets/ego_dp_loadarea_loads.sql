...
SELECT ego_scenario_log('v0.2.10','input','model_draft','ego_demand_hv_largescaleconsumer','ego_dp_loadarea_loads.sql',' ');

-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.10','input','openstreetmap','osm_deu_polygon_urban','ego_dp_loadarea_loads.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.10','output','openstreetmap','osm_deu_polygon_urban','ego_dp_loadarea_loads.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.10','temp','model_draft','osm_deu_polygon_urban_buffer100_mview','ego_dp_loadarea_loads.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.10','ouput','model_draft','ego_demand_la_osm','ego_dp_loadarea_loads.sql',' ');
...
-- -- 	ADD COLUMN ioer_sum double precision,
-- -- 	ADD COLUMN ioer_count integer,
-- -- 	ADD COLUMN ioer_density double precision,
-- -- 	ADD COLUMN area_ha double precision,
-- -- 	ADD COLUMN sector_area_residential double precision,
-- -- 	ADD COLUMN sector_area_retail double precision,
-- -- 	ADD COLUMN sector_area_industrial double precision,
-- -- 	ADD COLUMN sector_area_agricultural double precision,
-- -- 	ADD COLUMN sector_share_residential double precision,
-- -- 	ADD COLUMN sector_share_retail double precision,
-- -- 	ADD COLUMN sector_share_industrial double precision,
-- -- 	ADD COLUMN sector_share_agricultural double precision,
