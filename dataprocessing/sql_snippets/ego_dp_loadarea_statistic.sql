...
SELECT scenario_log('eGo_DP', 'v0.4.4','input','model_draft','ego_grid_hvmv_substation','ego_dp_loadarea_statistic.sql',' ');

-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','input','model_draft','ego_grid_mv_griddistrict','ego_dp_loadarea_statistic.sql',' ');

-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','input','model_draft','ego_demand_loadarea','ego_dp_loadarea_statistic.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','output','model_draft','ego_data_processing_results','ego_dp_loadarea_statistic.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','output','model_draft','ego_grid_mv_griddistrict','ego_dp_loadarea_statistic.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','output','boundaries','bkg_vg250_statistics_mview','ego_dp_loadarea_statistic.sql',' ');
