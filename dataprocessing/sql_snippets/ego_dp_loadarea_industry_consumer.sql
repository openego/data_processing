...
SELECT scenario_log('eGo_DP', 'v0.4.4','input','demand','ego_demand_federalstate','ego_dp_loadarea_industry_consumer.sql',' ');

-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','input','economy','destatis_gva_per_district','ego_dp_loadarea_industry_consumer.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','output','model_draft','ego_demand_per_gva','ego_dp_loadarea_industry_consumer.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','input','boundaries','bkg_vg250_4_krs_mview','ego_dp_loadarea_industry_consumer.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','output','model_draft','ego_landuse_industry','ego_dp_loadarea_industry_consumer.sql',' ');


-- Identify large scale consumer

-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','input','model_draft','ego_supply_conv_powerplant','ego_dp_loadarea_industry_consumer.sql',' ');
SELECT scenario_log('eGo_DP', 'v0.4.4','input','openstreetmap','osm_deu_polygon_urban_sector_3_industrial_mview','ego_dp_loadarea_industry_consumer.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','input','calc_ego_substation','ego_deu_voronoi_ehv','ego_dp_loadarea_industry_consumer.sql',' ');

-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','input','model_draft','ego_grid_hvmv_substation','ego_dp_loadarea_industry_consumer.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','output','model_draft','ego_demand_hv_largescaleconsumer','ego_dp_loadarea_industry_consumer.sql',' ');
