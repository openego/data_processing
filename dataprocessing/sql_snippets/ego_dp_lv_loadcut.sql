...
SELECT scenario_log('eGo_DP', 'v0.4.4','input','model_draft','ego_demand_loadarea','ego_dp_lv_loadcut.sql',' ');
SELECT scenario_log('eGo_DP', 'v0.4.4','input','model_draft','ego_grid_mvlv_substation_voronoi','ego_dp_lv_loadcut.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','temp','model_draft','ego_grid_lv_griddistrict_cut','ego_dp_lv_loadcut.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','temp','model_draft','ego_grid_lv_griddistrict_cut_1subst','ego_dp_lv_loadcut.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','temp','model_draft','ego_grid_lv_griddistrict_cut_0subst','ego_dp_lv_loadcut.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','temp','model_draft','ego_grid_lv_griddistrict_cut_xsubst','ego_dp_lv_loadcut.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','temp','model_draft','ego_grid_lv_griddistrict_cut_nn','ego_dp_lv_loadcut.sql',' ');
...
-- scenario log (project,version,io,schema_name,table_name,script_name,comment)
SELECT scenario_log('eGo_DP', 'v0.4.4','temp','model_draft','ego_grid_lv_griddistrict_cut_nn_collect','ego_dp_lv_loadcut.sql',' ');
