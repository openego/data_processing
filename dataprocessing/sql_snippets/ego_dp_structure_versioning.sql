...
CREATE TABLE 		grid.ego_dp_mv_griddistrict (
	...
	la_area double precision,
	free_area double precision,
	area_share double precision,
	consumption double precision,
	consumption_per_area double precision,
	dea_cnt integer,
	dea_capacity double precision,
	lv_dea_cnt integer,
	lv_dea_capacity double precision,
	mv_dea_cnt integer,
	mv_dea_capacity double precision,
	geom_type text,
...
CREATE TABLE 		supply.ego_dp_res_powerplant (
	...
	thermal_capacity double precision,
