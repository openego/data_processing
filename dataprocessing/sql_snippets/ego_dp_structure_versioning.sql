...
SELECT ego_scenario_log('v0.2.6','result','grid','ego_dp_ehv_substation','ego_scenario_log_setup.sql','hvmv substation');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','result','grid','ego_dp_hvmv_substation','ego_scenario_log_setup.sql','hvmv substation');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','result','grid','ego_dp_mvlv_substation','ego_scenario_log_setup.sql','hvmv substation');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','result','grid','ego_dp_ehv_griddistrict','ego_scenario_log_setup.sql','mv grid district');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','result','grid','ego_dp_mv_griddistrict','ego_scenario_log_setup.sql','mv grid district');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','result','grid','ego_dp_lv_griddistrict','ego_scenario_log_setup.sql','mv grid district');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.6','result','demand','ego_dp_loadarea','ego_scenario_log_setup.sql','load area');
