...
SELECT ego_scenario_log('v0.2.10','input','calc_renpass_gis','parameter_solar_feedin','ego_dp_powerflow_voronoi_climatepoint.sql',' ');
...
-- ego scenario log (version,io,schema_name,table_name,script_name,comment)
SELECT ego_scenario_log('v0.2.10','output','model_draft','renpassgis_economy_climatepoint_voronoi','ego_dp_powerflow_voronoi_climatepoint.sql',' ');
