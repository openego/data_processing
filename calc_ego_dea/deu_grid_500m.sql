...
-- Add ID
ALTER TABLE calc_ego_re.deu_grid_500m ADD "id" SERIAL;
ALTER TABLE calc_ego_re.deu_grid_500m ADD CONSTRAINT dea_grid_pkey PRIMARY KEY(id);

-- Add GIST Index
CREATE INDEX idx_deu_grid_500m_geom
