...
For the calculation of the *Share of renewable energy in el. consumption* the assumption-a_ where used.
...
.. csv-table::Installed generation capacities nd marginal costs
