"""
This file is part of the open_eGo project open_eGo: https://openegoproject.wordpress.com
...
latex_documents = [
  (master_doc, 'open_eGo_Data_Processing.tex', u'open_eGo Documentation',
...
man_pages = [
    (master_doc, 'data_processing', u'eGo Documentation',
     [author], 1)
]
