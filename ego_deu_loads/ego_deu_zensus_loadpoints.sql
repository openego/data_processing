...
UPDATE 	orig_geo_rli.rli_deu_loadpoints AS t1
...
CREATE INDEX	rli_deu_loadpoints_geom_grid_idx
...
INSERT INTO	orig_geo_rli.rli_deu_loadpoints_cluster(geom)
	...
	FROM    orig_geo_rli.rli_deu_loadpoints AS grid
...
-- "Grant oeuser"   (OK!) -> 100ms =0
GRANT ALL ON TABLE 	orig_geo_rli.rli_deu_loadpoints_cluster TO oeuser WITH GRANT OPTION;
ALTER TABLE		orig_geo_rli.rli_deu_loadpoints_cluster OWNER TO oeuser;
